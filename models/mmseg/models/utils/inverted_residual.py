...
"""这个程序文件包含了两个类InvertedResidual和InvertedResidualV3。这两个类分别代表了MobileNetV2和MobileNetV3中的倒置残差块。它们都是用于构建神经网络模型的模块，其中包含了卷积操作和一些配置参数。这些类使用PyTorch框架进行实现，用于构建深度学习模型中的倒置残差结构。"""
